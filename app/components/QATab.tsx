    ...
    <div className="space-y-8">
      ...
      <div className="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl p-10 border border-white/40 space-y-8">
        ...
        <button
          ...
          className="px-8 py-3 rounded-2xl bg-gradient-to-r from-black to-gray-800 text-white text-sm font-medium shadow-lg hover:shadow-xl transition disabled:opacity-50 cursor-pointer"
        >
      ...
      <div className="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl p-10 border border-white/40 space-y-8">
        ...
        <button
          onClick={ask}
          disabled={asking}
          className="px-8 py-3 rounded-2xl bg-gradient-to-r from-blue-600 to-purple-600 text-white text-sm font-medium shadow-lg hover:shadow-xl transition disabled:opacity-50 cursor-pointer"
        >
